...
const Store=(props)=> {
                ...
                {dato.admin ?
                    <div className={styles.revision}>
                        <Card key={key.id_recurso} className={styles.libro}
                              onClick={(e) => detalles(key.id_recurso, e)}>
    ...
    const categorias = () => (
        dato.categorias.map((key) => (
            <div>
                <input className={styles2.marcador} type="checkbox" value="" id={key.id_categoria}
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                        <Card className={styles.carta}>
                            <Card.Header className={styles.content}>
                                ...
                                <Form.Control name={"barraBusqueda"} className={styles.barraBusqueda}
                                              onChange={handleChange}/>
